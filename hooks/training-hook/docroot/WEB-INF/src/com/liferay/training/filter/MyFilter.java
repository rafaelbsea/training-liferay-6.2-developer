...
public class MyFilter implements Filter {
	...
	public void doFilter(
		...
		System.out.println(
			"Called MyFilter.doFilter( servlet Request: " + servletRequest + ", servlet Response: " +
				servletResponse + ", filter Chain: " + filterChain + ") for URI: " + uri);
	...
	public void init(FilterConfig filterConfig) {
		System.out.println(
			"Called MyFilter.init(" + filterConfig + ") where hello=" +
